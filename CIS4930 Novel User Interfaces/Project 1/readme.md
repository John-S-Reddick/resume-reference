...
<h5><a target="_blank" href="https://canvas.unf.edu/courses/100860/assignments/1328145.com]">Submission</a> Due: 2/8/24 11:59 pm<h5/>  
...
<a name="recognizers"/> <h2><li> Recognizers</h2>        
            ...
            <ol>
                <a name="one-dollar"/> <h3><li>$1 Recognizer <a target="_blank" target="_blank" href="http://faculty.washington.edu/wobbrock/pubs/uist-07.01.pdf">Link</a></h3>
                </li>
                <a name="q-dollar"/> <h3><li>$Q Recognizer <a target="_blank" href="http://faculty.washington.edu/wobbrock/pubs/mobilehci-18.pdf">Link</a></h3>
                </li>
                <a name="penny-pincher"/><h3><li>Penny Pincher Recognizer <a target="_blank" href="https://www.eecs.ucf.edu/isuelab/publications/pubs/gi2015_eugene.pdf">Link</a></h3>
                </li>     
            </ol>
...
<a name="deliverables"/><h2><li> Deliverables</h2>
    <ol>
        <li>-[ ] Upload your source code to Canvas <a target="_blank" href="https://canvas.unf.edu/courses/100860/assignments/1328145.com]">here</a></li>
...
<ol>
    ...
    <a name="jet-brains"/><h2><li> Jet Brains</h2>
        I originally used <a target="_blank" href="https://www.jetbrains.com/clion/download/#section=windows">CLion</a> to develop with C++, but have since switched to JetBrain's
        <a target="_blank" href="https://www.jetbrains.com/pycharm/download/">PyCharm</a> for development. These have been massive successes and make for easy integration with GitHub,
    ...
    <a name="markdown"/><h2><li> Markdown Reference</h2>
        The markdown reference guide <a target="_blank" href="https://www.markdownguide.org/basic-syntax/")>here</a> has allowed me to document my readme in style while also empowering this readme
        ...
        <a target="_blank" href="https://stackoverflow.com/questions/11948245/markdown-to-create-pages-and-table-of-contents#27953547")>this</a> Stack exchange article.
